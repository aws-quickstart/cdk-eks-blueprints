...
| [`ApacheAirflowAddOn`](./apache-airflow)                                           | This add-on is an implementation of Apache Airflow on EKS using the official helm chart.                                                  | ✅ |
...
| [`Backstage`](./backstage)                      | Installs Backstage.                                                                        | ✅ |
...
| [`ContainerInsightsAddOn`](./container-insights)                       | Adds support for container insights.                                                          | ✅ | ✅                                         |
...
| [`XrayAddOn`](./xray)                                                  | Adds XRay Daemon to the EKS Cluster.                                                                                                   | NA | NA
