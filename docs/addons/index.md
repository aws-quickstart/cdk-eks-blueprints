...
| [`Rafay`](./rafay.md) | Adds [Rafay’s Kubernetes Operations Platform (KOP)](https://rafay.co/contact/) to the EKS Cluster.  Rafay allows you to deploy, operate, and manage the lifecycle of Kubernetes clusters | ✅ |
