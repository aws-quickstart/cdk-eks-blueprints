...
```bash
npm install -g aws-cdk@2.1129.0
```
...
- [x] [Calico](https://docs.tigera.io/calico/latest/about) into your cluster to support Network policies.
