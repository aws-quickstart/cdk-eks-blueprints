...
export default class BlueprintConstruct {
    constructor(scope: Construct, props: cdk.StackProps) {
        ...
        blueprints.EksBlueprint.builder()
            .addOns(...addOns)
            .resourceProvider(blueprints.GlobalResources.Vpc, new blueprints.VpcProvider("vpc-088d404bdaea2c7eb","100.64.0.0/16", ["100.64.0.0/24","100.64.1.0/24","100.64.2.0/24"]))
