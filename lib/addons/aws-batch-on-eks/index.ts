...
export class AwsBatchAddOn implements ClusterAddOn {
  deploy(clusterInfo: ClusterInfo): Promise<Construct> {
    ...
    // Create the service role used by AWS Batch on EKS 
    const batchOnEksSlr = new CfnServiceLinkedRole(cluster.stack, 'BatchServiceRole', {
    ...
    return Promise.resolve(batchOnEksSlr);
