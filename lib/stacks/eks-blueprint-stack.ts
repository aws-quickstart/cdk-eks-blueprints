...
export class BlueprintPropsConstraints
  implements constraints.ConstraintsType<EksBlueprintProps>
{
  /**
...
export class BlueprintBuilder implements spi.AsyncStackBuilder {
  ...
  constructor() {
    this.props = {
      addOns: new Array<spi.ClusterAddOn>(),
      teams: new Array<spi.Team>(),
  ...
  public enableGitOps(mode?: spi.GitOpsMode): this {
    this.props = {
      ...this.props,
      ...{ enableGitOpsMode: mode ?? spi.GitOpsMode.APP_OF_APPS },
    };
    return this;
  }
  ...
  public withBlueprintProps(props: Partial<EksBlueprintProps>): this {
    ...
    if (props.resourceProviders) {
      this.props.resourceProviders = new Map([
        ...resourceProviders!.entries(),
        ...props.resourceProviders.entries(),
      ]);
    }
    return this;
  }
  ...
  public addOns(...addOns: spi.ClusterAddOn[]): this {
    this.props = {
      ...this.props,
      ...{ addOns: this.props.addOns?.concat(addOns) },
    };
    return this;
  }
  ...
  public teams(...teams: spi.Team[]): this {
    this.props = {
      ...this.props,
      ...{ teams: this.props.teams?.concat(teams) },
    };
    return this;
  }
...
export class EksBlueprint extends cdk.Stack {
  ...
  constructor(
    ...
    super(
      scope,
      blueprintProps.id,
      utils.withUsageTracking(EksBlueprint.USAGE_ID, props)
    );
    ...
    let enableLogTypes: string[] | undefined =
      blueprintProps.enableControlPlaneLogTypes;
    if (enableLogTypes) {
      utils.setupClusterLogging(
        this.clusterInfo.cluster.stack,
